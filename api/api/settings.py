...
# Configurações do Django REST Framework (DRF) e Paginação padrão
REST_FRAMEWORK = {
...
# Configurações do JWT com durações dos tokens
SIMPLE_JWT = {
...
# Configurações do CORS com as rotas permitidas
